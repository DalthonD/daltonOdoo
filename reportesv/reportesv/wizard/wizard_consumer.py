...
class wizard_sv_consumer_report(models.TransientModel):
    ...
    stock_location_id=fields.Many2one('stock_location', string="Sucursal", help="Sucursal de la que se desea el Libro de IVA",default=lambda self: self.env.user.x_stock_location_id.id)
