...
class sv_reportWizard(models.TransientModel):
    ...
    select aml.date as fecha
        ...
        return self.env.ref('purchase_report.purchase_report_pdf').report_action(self, data=create_view()) #purchase_report.strategiksv_purchase_report_pdf  purchase_report.purchase_report_pdf
