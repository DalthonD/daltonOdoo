...
class res_company(models.Model):
    ...
    @api.multi
    def get_consumer_details(self, company_id, date_year, date_month):
        data = {}
        ...
        and afp.sv_contribuyente=False
        and ai.state in ('cancel')
        )S )SS group by SS.fecha, SS.Grupo,SS.estado order by SS.fecha, SS.Grupo))""".format(company_id,date_year,date_month)
